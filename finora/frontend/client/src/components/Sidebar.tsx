...
import { LayoutDashboard, Wallet, Tag, Target, User, TrendingUp, LogOut, FileBarChart, Bot, FlaskConical } from "lucide-react";
...
const mainItems = [
  ...
  { label: "Simulador",   href: "/simulator",    icon: FlaskConical },
